...
class FirstPage extends StatefulWidget {
  const FirstPage({Key? key, required this.onValueChanged, required this.cameras, required this.active}) : super(key: key);
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async  {
                              ...
                              final a = await cameraController.takePicture();
